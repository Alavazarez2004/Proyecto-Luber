    ...
    return (
        <section className='homee'>
            ...
            <form className='selection-method' aria-required onSubmit={submitMethodData}>
                ...
                <input className='textoingresar' type="text" id='funcion' onInput={setFunction} placeholder='Ingresar la función'/>
                ...
                <br />
                <label>Administradores @Miguel Angel Alavazarez Hernandez - @Gabriel Reyes Hernandez - @Jordi Daniel Reyes Hernandez</label>
            </form>
        </section>
    )
}
